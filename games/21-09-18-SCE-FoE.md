...
### Tzaangors and Chaos Lord

These two units exceeded expectations, even though it would be nice to remember the *Tzaangors* also have a Hero Phase ability to deal mortal wounds, which was not used at all throughout the game.

The *Chaos Lord*'s **Daemonic Power** spell is amazing.

### Evocators

They definitely are a force to be feared... they ripped through the *Chaos Marauders* and *Kairic Acolytes* like they were nothing.

### Gavriel

This guy really needs to have a second **Command Point** stored to guarantee his success. He is very lackluster when the charge fails...

### Lord-Relictor

Still super-good, although the *Lord-Veritant* might actually be better if all you want is to pray for *Translocation*.

### Slaughterpriest

His prayer is insanely good. Also, even if it worked out, it was probably a *terrible* idea to charge *Aventis* with him...

### Aventis

Hard to take any conclusions on him. He was charged into a very misplaced position, which was a mistake, but he rolled horribly on attacking the *Slaughterpriest* (which statistically he should kill over 60% of the time) and somehow was then killed by him (which was only a 20% chance more or less).

### Blood Warriors

These guys are not worth their points...

## Gameplay improvements

### Fist of the Everchosen

1. Should not have charged the *Sequitors* with the *Blood Warriors*, the strength of the *Blood Warriors* was overestimated to be somewhat like *Liberators*
2. Should remember to use the *Tzaangors* Hero Phase Skill. It's free...
3. Just don't run *Blood Warriors* at all. *Bloodreavers* are better straight up (Rend!)

### Stormcast Eternals

1. If the *Gavriel-Bomb* fails, don't charge the rest of your army in
2. *Aventis* is really good, but not 1v4 good
3. Deployment was pretty wonky, maybe the *Sequitors* should've also been in **Deep Strike**?
4. The *Prosecutors* and **Translocations** could've made a play for the right-flank objective, instead of fighting where the opponent was strong.
